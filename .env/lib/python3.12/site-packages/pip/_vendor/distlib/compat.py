...
try:
    ...
    def which(cmd, mode=os.F_OK | os.X_OK, path=None):
        ...
        `mode` default to os.F_OK | os.X_OK. `path` default to the result
...
try:
    ...
    class OrderedDict(dict):
        ...
        def fromkeys(cls, iterable, value=None):
            ...
            and values equal to v (which default to None).
...
try:
    ...
    class BaseConfigurator(object):
        """
        The configurator base class which defines some useful default.
        """
